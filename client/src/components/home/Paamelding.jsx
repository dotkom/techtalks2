...
//Avoid blinking by calculating time left immediately
...
const Paamelding = props => {
  ...
  const [timeLeft, setTimeLeft] = useState(calcTimeLeft(PaameldingsDate));
  ...
  useEffect(() => {
    function timeleftCallback() {
      setTimeLeft(calcTimeLeft(PaameldingsDate));
    }
    setTimeout(timeleftCallback, 1000);
