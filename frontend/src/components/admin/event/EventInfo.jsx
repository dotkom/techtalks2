            ...
            <Table id="eventInfo">
              <tbody>
                ...
                <tr>
                  ...
                  <Td>
                    {new Date(påmeldingsStart).toLocaleDateString()} {new Date(påmeldingsStart).toLocaleTimeString()}
                  </Td>
                </tr>
              </tbody>
            </Table>
        ...
        <div>
          ...
          <Table id="eventInfo">
            <tbody>
              <tr>
                <Td>
                  <InputField type="date" label="Dato: " val={dato} id={'eventDate'} updateValue={changeDate} />
                </Td>
              </tr>
              <tr>
                <Td>
                  <InputField type="textarea" label="Beskrivelse: " val={beskrivelse} updateValue={changeDesc} />
                </Td>
              </tr>
              <tr>
                <Td>
                  <InputField type="number" label="Antall plasser: " val={antallPlasser} updateValue={changePlasser} />
                </Td>
              </tr>
              <tr>
                <Td>
                  <InputField type="text" label="Link: " val={link} updateValue={changeLink} />
                </Td>
              </tr>
              <tr>
                <Td>
                  <InputField type="datetime-local" val={påmeldingsStart} updateValue={changeStart} />
                </Td>
              </tr>
            </tbody>
          </Table>
